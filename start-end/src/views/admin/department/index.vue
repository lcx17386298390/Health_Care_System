<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="科室挂号数量" prop="orders">
        <el-input
          v-model="queryParams.orders"
          placeholder="请输入科室挂号数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="挂号信息id" prop="aid">
        <el-input
          v-model="queryParams.aid"
          placeholder="请输入挂号信息id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科室名" align="center" prop="name" />
      <el-table-column label="医生姓名" align="center" prop="dname" />
      <el-table-column label="医生id" align="center" prop="did" />
      <el-table-column label="科室挂号数量" align="center" prop="orders" />
      <el-table-column label="挂号信息id" align="center" prop="aid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="科室名" prop="name">
          <el-input v-model="form.name" placeholder="请输入科室名" />
        </el-form-item>
        <el-form-item label="医生姓名" prop="dname">
          <el-input v-model="form.dname" placeholder="请输入医生姓名" />
        </el-form-item>
        <el-form-item label="医生id" prop="did">
          <el-input v-model="form.did" placeholder="请输入医生id" />
        </el-form-item>
        <el-form-item label="科室挂号数量" prop="orders">
          <el-input v-model="form.orders" placeholder="请输入科室挂号数量" />
        </el-form-item>
        <el-form-item label="挂号信息id" prop="aid">
          <el-input v-model="form.aid" placeholder="请输入挂号信息id" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除科室信息编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('http://localhost:8002/department/department/export', {
        ...this.queryParams
